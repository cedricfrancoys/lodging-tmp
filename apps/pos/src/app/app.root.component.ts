...
export class AppRootComponent implements OnInit {
    ...
    private MAX_IDLE = 30 * 60 * 1000;       // set a max idle time of 30 mins
    ...
    public async ngOnInit() {
        ...
        try {
            ...
            const data = await this.api.getMenu('lodging', 'pos.left');
            ...
            const top_menu:any = await this.api.getMenu('lodging', 'pos.top');
