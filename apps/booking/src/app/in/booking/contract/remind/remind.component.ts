...
@Component({
  selector: 'booking-contract-remind',
  templateUrl: 'remind.component.html',
  styleUrls: ['remind.component.scss']
})
export class BookingContractRemindComponent implements OnInit, AfterContentInit {
    ...
    public async onSend() {
        ...
        */
        ...
        try {
            this.loading = true;
            const response:any = await this.api.call('?do=lodging_booking_send-contract-reminder', {
            ...
            this.is_sent = true;
            this.snack.open("Contrat envoyée avec succès.");
            this.loading = false;
        }
        catch(response:any) {
