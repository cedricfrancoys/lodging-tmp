	...
	function generateDates(year,month){
		...
		[].slice.call(that.el.querySelectorAll('.d-table')).forEach(function(element, index) {
			...
			[].slice.call(element.querySelectorAll('.d-table input')).forEach(function(inputEl,i) {
                ...
                // hide cells with distinct month (previous and next : possibly first and last rows)
...
*/                        
                        ...
                        for(var z = 0;z < _highlights.length;z++){
                            if(typeof _highlights[z].class == 'object') {
                                _highlights[z].class.forEach(function(elem) {
                                    labelEl.classList.add(elem);
                                });                            
                            }
                            else labelEl.classList.add(_highlights[z].class);
                        }
					}
				}
			});
