...
$values['i18n'] = [
    ...
    'customer_name'     => Setting::get_value('lodging', 'locale', 'i18n.customer_name', null, 0, $params['lang']),
    'customer_address'  => Setting::get_value('lodging', 'locale', 'i18n.customer_address', null, 0, $params['lang']),
    ...
    'customer_num'      => Setting::get_value('lodging', 'locale', 'i18n.customer_num', null, 0, $params['lang']),
    ...
    'amount_to_be_refunded' => Setting::get_value('lodging', 'locale', 'i18n.amount_to_be_refunded', null, 0, $params['lang']),
    ...
    'origin'                => Setting::get_value('lodging', 'locale', 'i18n.origin', null, 0, $params['lang']),
    'received'              => Setting::get_value('lodging', 'locale', 'i18n.received', null, 0, $params['lang']),
    'left_to_pay'           => Setting::get_value('lodging', 'locale', 'i18n.left_to_pay', null, 0, $params['lang']),
    'payments_history'      => Setting::get_value('lodging', 'locale', 'i18n.payments_history', null, 0, $params['lang']),
];
